<script setup>
import { ref } from 'vue';
import ApplicationLogo from '@/Components/AppLogoMin.vue';
            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('propriedade')" :active="route().current('propriedade')">
                                    Propriedade
                                </NavLink>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('propriedade')" :active="route().current('propriedade')">
                            Propriedade
                        </ResponsiveNavLink>
